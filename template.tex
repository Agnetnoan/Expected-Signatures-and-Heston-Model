...
In this study, we aimed to evaluate the performance of the expected signatures obtained from the Heston pricing model through the simulation of various combinations of varying parameters. Specifically, we considered combinations of one, two and three parameters simultaneously. %The results are illustrated in the form of graphs...
...
\begin{figure}[!htbp]
	\centering
	\includegraphics[width=\textwidth]{1_parameter_sigma.png}
...
\begin{figure}[!htbp]
	\centering
	\includegraphics[width=\textwidth]{1_parameter_theta.png}
...
\begin{figure}[!htbp]
	\centering
	\includegraphics[width=\textwidth]{1_parameter_kappa.png}
...
\begin{figure}[!htbp]
	\centering
	\includegraphics[width=\textwidth]{1_parameter_rho.png}
...
\begin{figure}[!htbp]
	\centering
	\includegraphics[width=\textwidth]{1_parameter_r.png}
...
%As a result, we can identify the following distinctive features in the plots.Keys (1), (1,3) and (3,1) have a common pattern and trend. In the case where $\theta$ was included in the outer loop, the plots are such that the spread increases as the value of $\theta$ increases. In other cases, however, the scatter is evenly distributed across all parameter values.
